...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "👇 Нажми на кнопку «📂 Открыть магазин», чтобы посмотреть услуги, или «📖 Инструкция».",
        reply_markup=main_keyboard
    )

async def open_shop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🛒 Нажми на кнопку «Открыть магазин» внизу экрана, чтобы перейти в каталог услуг.\n\n"
...
async def show_instruction(update: Update, context: ContextTypes.DEFAULT_TYPE):
    instruction_text = (
        ...
        "1. Нажми на кнопку **«📂 Открыть магазин»** внизу экрана.\n"
        "2. Внутри мини-приложения выбери нужную услугу.\n"
        "3. Нажми **«Купить»** — оплата проходит внутри Telegram.\n"
        "4. После оплаты ты получишь доступ к услуге.\n\n"
        "💡 Если что-то непонятно — напиши в чат, я отвечу."
    )
